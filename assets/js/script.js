...
// Dirubah 
const pengirim = "Reza";
const nomorWa = "6282131208404" // awalan nomor 0 harus di awalin 62
const textWa = "Minal Aidzin wal Faidzin, Mohon Maaf Lahir dan Batin"
const pesan = `Taqabbalallahu minna wa minkum, Kemenangan sejati adalah hati yang kembali suci. Mohon maaf lahir dan batin, semuanya!
- Reza`;
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    ...
    let txt = `Selamat hari raya idul fitri lee!! Halo, ${result.value.login}, ${pesan}`;
